...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/customer/customer/form?id=${customer.id}">客户资料<shiro:hasPermission name="customer:customer:edit">${not empty customer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="customer:customer:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="customer" action="${ctx}/customer/customer/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="div-b">
				...
				<div class="controls">
					<form:input path="customerNumber" readonly="true" htmlEscape="false" maxlength="32" class="input-xlarge "/>
				</div>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="div-b">
				...
				<div class="controls">
					<form:select path="taxableCategory" class="input-xlselect ">
						<form:option value="" label=""/>
						<form:options items="${fns:getDictList('taxable_category')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
				</div>
			</div>
		</div>
			...
			<div class="div-b">
				...
				<div class="controls">
					<form:select path="bizScope" class="input-xlselect ">
						<form:option value="" label=""/>
						<form:options items="${fns:getDictList('biz_scope')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="div-a">
				...
				<div class="controls">
					<sys:treeselect id="stopUser" name="stopUser.id" value="${customer.stopUser.id}" labelName="" labelValue="${customer.stopUser.name}"
						title="用户" url="/sys/office/treeData?type=3" cssClass="input-large " allowClear="true" notAllowSelectParent="true"/>
				</div>
			</div>
			<div class="div-b">
				<label class="control-label">停用时间：</label>
				<div class="controls">
					<input name="stopTime" type="text" readonly="readonly" maxlength="20" class="input-xlarge Wdate "
		...
		<div class="control-group">
			...
			<div class="div-b">
				...
				<div class="controls">
					<form:input path="internalSerialNumber" htmlEscape="false" maxlength="255" class="input-xlarge "/>
				</div>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="div-b">
				...
				<div class="controls">
					<form:radiobuttons path="settlementFlag" items="${fns:getDictList('settlement_flag')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
				</div>
			</div>
		</div>
		<div class="control-group">
