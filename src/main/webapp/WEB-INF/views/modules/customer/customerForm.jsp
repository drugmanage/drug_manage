...
<form:form id="inputForm" modelAttribute="customer" action="${ctx}/customer/customer/save" method="post"
        ...
        <div class="div-b">
            ...
            <div class="controls">
                <form:select path="taxableCategory" class="input-xlselect ">
                    <form:option value="" label=""/>
                    <form:options items="${fns:getDictList('taxable_category')}" itemLabel="label" itemValue="value"
                                  htmlEscape="false"/>
                </form:select>
            </div>
        </div>
    ...
    <div class="control-group">
        ...
        <div class="div-b">
            ...
            <div class="controls">
                <form:radiobuttons path="settlementFlag" items="${fns:getDictList('settlement_flag')}" itemLabel="label"
                                   itemValue="value" htmlEscape="false" class=""/>
            </div>
        </div>
    </div>
