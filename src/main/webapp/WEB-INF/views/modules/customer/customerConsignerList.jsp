...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="customerConsigner">
			<tr>
				<td><a href="${ctx}/customer/customerConsigner/form?id=${customerConsigner.id}">
					<fmt:formatDate value="${customerConsigner.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</a></td>
				<td>
					${customerConsigner.remarks}
				</td>
