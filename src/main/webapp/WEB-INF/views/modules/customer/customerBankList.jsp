...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/customer/customerBank/">客户银行卡信息列表</a></li>
		<shiro:hasPermission name="customer:customerBank:edit"><li><a href="${ctx}/customer/customerBank/form">客户银行卡信息添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="customerBank" action="${ctx}/customer/customerBank/" method="post" class="breadcrumb form-search">
