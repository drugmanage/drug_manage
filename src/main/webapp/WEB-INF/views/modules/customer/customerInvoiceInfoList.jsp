...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/customer/customerInvoiceInfo/">开票信息列表</a></li>
		<shiro:hasPermission name="customer:customerInvoiceInfo:edit"><li><a href="${ctx}/customer/customerInvoiceInfo/form">开票信息添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="customerInvoiceInfo" action="${ctx}/customer/customerInvoiceInfo/" method="post" class="breadcrumb form-search">
