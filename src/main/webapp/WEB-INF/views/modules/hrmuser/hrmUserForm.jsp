...
<form:form id="inputForm" modelAttribute="hrmUser" action="${ctx}/hrmuser/hrmUser/save" method="post"
        ...
        <div class="div-a">
            ...
            <div class="controls">
                <sys:treeselect id="sysUser" name="sysUser" value="${hrmUser.sysUser.id}" labelName=""
                                ...
                                title="用户" url="/sys/office/treeData?type=3" cssClass="input-large" allowClear="true"
        ...
        <div class="div-a">
            ...
            <div class="controls">
                <input name="birth" type="text" readonly="readonly" maxlength="20" class="input-xlarge Wdate "
                       value="<fmt:formatDate value="${hrmUser.birth}" pattern="yyyy-MM-dd HH:mm:ss"/>"
    ...
    <div class="control-group">
        ...
        <div class="div-b">
            ...
            <div class="controls">
                <form:radiobuttons path="maritalStatus" items="${fns:getDictList('marital_status')}" itemLabel="label"
    ...
    <div class="control-group">
        <div class="div-a">
            ...
            <div class="controls">
                <form:input path="emergencyContactName" htmlEscape="false" maxlength="32" class="input-xlarge "/>
            </div>
        </div>
        <div class="div-b">
            <label class="control-label">紧急联系人电话：</label>
            <div class="controls">
                <form:input path="emergencyContactPhone" htmlEscape="false" maxlength="20" class="input-xlarge "/>
            </div>
        </div>
    ...
    <div class="control-group">
        ...
        <div class="div-b">
            ...
            <div class="controls">
                <input name="applyTime" type="text" readonly="readonly" maxlength="20" class="input-xlarge Wdate "
        ...
        <div class="div-a">
            ...
            <div class="controls">
                <form:select path="certType" class="input-xlarge ">
                    <form:option value="" label=""/>
                    <form:options items="${fns:getDictList('user_cert_type')}" itemLabel="label" itemValue="value"
                                  htmlEscape="false"/>
                </form:select>
            </div>
        </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:radiobuttons path="companyType" items="${fns:getDictList('user_company_type')}" itemLabel="label"
                               itemValue="value" htmlEscape="false" class=""/>
        </div>
    </div>
    <div class="control-group">
