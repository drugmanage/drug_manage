...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="purchase:purchaseOrder:edit"><li><a href="${ctx}/purchase/purchaseOrder/form">采购订单添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="purchaseOrder" action="${ctx}/purchase/purchaseOrder/" method="post" class="breadcrumb form-search">
