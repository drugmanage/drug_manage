	...
	<form:form id="inputForm" modelAttribute="supplier" action="${ctx}/supplier/supplier/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="div-b">
				...
				<div class="controls">
					<form:textarea path="stopReason" htmlEscape="false" rows="4" maxlength="255" class="input-xlarge "/>
				</div>
			</div>
		</div>
		<div class="control-group">
			<div class="div-a">
				...
				<div class="controls">
					<sys:treeselect id="stopUser" name="stopUser.id" value="${supplier.stopUser.id}" labelName="" labelValue="${supplier.stopUser.name}"
