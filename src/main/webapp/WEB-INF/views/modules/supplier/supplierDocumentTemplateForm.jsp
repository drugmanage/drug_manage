	...
	<c:forEach items="${hrmUser.hrmBanksList }" var="item" varStatus="i">
		<tr id="bank_tr_${i.index}">
			...
			<td>
				...
				<select class="table-form-control" name="supplierDocumentTemplateList[${i.index }].sex">
			...
			<td>
				<input type="text" class="table-form-control" name="supplierDocumentTemplateList[${i.index }].bankNumber"
					   value="${item.bankNumber }" valid='vtext'/>
			</td>
			<td>
				<select class="table-form-control" name="supplierDocumentTemplateList[${i.index }].status">
			...
			<td>
				<input type="hidden" id="nameImagefront${i.index }" name="supplierDocumentTemplateList[${i.index }].positivePhoto" value="${item.positivePhoto}"/>
			...
			<td>
				<input type="hidden" id="nameImageback${i.index }" name="supplierDocumentTemplateList[${i.index }].backPhoto" value="${item.backPhoto}"/>
			...
			<td>
				<input type="text" class="table-form-control" name="supplierDocumentTemplateList[${i.index }].remarks"
					   value="${item.remarks }"
					   valid='vtext'/>
			</td>
			<td>
